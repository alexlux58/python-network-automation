...
commands = ['int loopback 0', 'ip address 1.1.1.1 255.255.255.255',
            'exit', 'username netmiko secret cisco']
...
# in enters automatically into global config mode and exits automatically at the end
